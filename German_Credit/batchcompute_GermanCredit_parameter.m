...
for i = 1:length(mat_files)
    ...
    if startsWith(file_name, 'MaOEADPP123_GermanCredit_CFEGenerator_M2_D24_')
...
for s = 1:length(all_data)
    ...
    Original_X = table2array(Original_Data(s,1:end-1)); 
    Original_X = Original_X';
    Original_Y = Original_Data(:,end).Risk(s);
    % 找出需要删除的行索引
